	...
	HVS390: {
		...
		get SOURCES_ME() {
			...
			let system = [
				...
				{ id: 29, label: "Still 3", sName: "STL3" },
				{ id: 30, label: "Still 4", sName: "STL4" },
				{ id: 37, label: "Color Bars", sName: "BARS" },
				{ id: 38, label: "Matte 1", sName: "MAT1" },
				{ id: 39, label: "Matte 2", sName: "MAT2" },
				{ id: 40, label: "Color Key Fill", sName: "CKFL" },
				{ id: 41, label: "Color Key Key", sName: "CKKY" },
		...
		get SOURCES_AUX() {
			let additional = [
				...
				{ id: 42, label: "Program 1", sName: "PGM1" },
				{ id: 43, label: "Preview 1", sName: "PVW1" },
				{ id: 44, label: "Clean 1", sName: "CLN1" },
				{ id: 46, label: "Program 2", sName: "PGM2" },
				{ id: 47, label: "Preview 2", sName: "PVW2" },
				{ id: 48, label: "Clean 2", sName: "CLN2" },
				{ id: 54, label: "Multi-View 1", sName: "MV 1" },
				{ id: 55, label: "Multi-View 2", sName: "MV 2" },
			];
